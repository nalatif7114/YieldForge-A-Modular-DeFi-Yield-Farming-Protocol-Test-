...
export interface YieldForgeTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface YieldForgeToken extends BaseContract {
  connect(runner?: ContractRunner | null): YieldForgeToken;
  waitForDeployment(): Promise<this>;

  interface: YieldForgeTokenInterface;
