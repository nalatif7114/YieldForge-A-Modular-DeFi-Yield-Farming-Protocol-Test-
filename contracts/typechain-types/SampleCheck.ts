...
export interface SampleCheckInterface extends Interface {
...
export interface SampleCheck extends BaseContract {
  connect(runner?: ContractRunner | null): SampleCheck;
  waitForDeployment(): Promise<this>;

  interface: SampleCheckInterface;
